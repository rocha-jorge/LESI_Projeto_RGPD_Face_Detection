...
# --- CONFIG ---
DETECTION_OUTPUT_DIR = PROJECT_ROOT / "image_detection_output"
ANONYMIZATION_OUTPUT_DIR = IMAGE_OUTPUT
ERROR_DIR = PROJECT_ROOT / "image_detection_error"
BLUR_STRENGTH = 100  # Higher value = stronger blur

# Directory creation is handled centrally by utils.paths.ensure_dirs
...
def blur_faces(img: Path, faces: list[tuple[int, int, int, int]] | None, image_error: Path) -> bool:
